...
- \`message:"pattern"\` - Search commit message text`,
  ...
  schema: z.object({
    query: z
      ...
      .min(1)
      .describe(
        "Search query. Include 'type:commit' or 'type:diff' for best results.",
      ),
    maxResults: z
      .number()
      .int()
  ...
  examples: [
    ...
    {
      params: { query: "type:diff useState repo:github.com/facebook/react after:2024-01-01", maxResults: 20 },
